# aurora-postgres-replica variables
#--------------------------------------------------------------
...
# aurora-postgres-replica locals
#--------------------------------------------------------------
locals {
  postgres_replica_enabled = "${var.postgres_replica_enabled == "true"}"
  postgres_replica_name    = "${length(var.postgres_replica_name) > 0 ? var.postgres_replica_name : module.label.name}"
}

# aurora-postgres-replica modules
#--------------------------------------------------------------
module "postgres_replica" {
  ...
  stage              = "${var.stage}"
  name               = "${local.postgres_replica_name}"
  cluster_identifier = "${local.postgres_replica_name}"
...
# aurora-postgres-replica resources
#--------------------------------------------------------------
...
# aurora-postgres-replica outputs
#--------------------------------------------------------------
